...
parser.add_argument('-A', action='append_const', dest='const_collection', const=['value-1-to-append', 'value-2-to-append'], default=[], help='Add different values to list')
